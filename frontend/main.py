...
# --- 1. CONFIGURACIÓN DE LA APP (Siempre al inicio) ---
st.set_page_config(
...
# Usamos variables de entorno para ser profesionales, con fallback a localhost
